from lambeq import spiders_reader, Rewriter, MPSAnsatz, AtomicType, PytorchModel, PytorchTrainer, Dataset
...
tensor_ansatz = MPSAnsatz({AtomicType.NOUN: Dim(2), AtomicType.SENTENCE: Dim(2)}, 2)
...
train_diagrams = spiders_reader.sentences2diagrams(train_sentences)
test_diagrams = spiders_reader.sentences2diagrams(test_sentences)
