...
pip = Pipeline(parser, ansatz)
#pip.add_rewriter_rules(Pipeline.SUPPORTED_RULES[0], Pipeline.SUPPORTED_RULES[1], Pipeline.SUPPORTED_RULES[4])
train_labels, train_circuits = pip.create_circuits_and_labels("n", "code/pipeline/mc_train_data.txt")
test_labels, test_circuits = pip.create_circuits_and_labels("n", "code/pipeline/mc_test_data.txt")
